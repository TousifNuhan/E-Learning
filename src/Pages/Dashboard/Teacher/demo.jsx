...
const MyAddedClasses = () => {
  ...
  // 1. Fetch user-specific classes from backend
  ...
  // Open Update Modal and populate state
  const handleOpenUpdate = (cls) => {
    setEditingClass(cls);
    setFormData({
      title: cls.title || '',
      category: cls.category || '',
      price: cls.price !== undefined ? cls.price : '',
      originalPrice: cls.originalPrice !== undefined ? cls.originalPrice : '',
      ...
      // NEW: seed objectives/requirements from existing class data, or start with one empty field
  ...
  // Field change handler for top-level keys
  const handleChange = (field, value) => {
    setFormData((prev) => ({ ...prev, [field]: value }));
  };

  // NEW: Objectives Handlers
  ...
  const handleUpdateSubmit = (e) => {
    ...
    // NEW: strip empty objective/requirement strings before sending
    ...
    // NOTE: assignments are NOT part of this payload anymore.
    // Real assignment data lives in the separate assignmentsCollection,
    // managed from the class dashboard (My Class -> Assignments), not here.
    const payload = {
      ...formData,
  ...
  if (initializing || isLoading) {
    return (
      <div className="bg-white p-12 rounded-2xl border border-stone-200 text-center py-24">
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
            ...
            return (
              ...
              >
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-3 pt-1 flex-wrap">
                      ...
                      <span className="text-xs font-bold text-stone-800 bg-stone-100 px-2 py-0.5 rounded-md">
                        ${cls.price !== undefined ? parseFloat(cls.price).toFixed(2) : '0.00'}
                      </span>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-2 md:pt-0 border-t md:border-t-0 border-stone-100">
                  ...
                  {/* See Details Button (Disabled until Approved) */}
                  {isApproved ? (
                    <Link
      ...
      {/* Comprehensive Edit Class Modal */}
      {editingClass && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-stone-900 rounded-2xl max-w-4xl w-full p-6 space-y-6 shadow-2xl relative my-8 max-h-[90vh] overflow-y-auto border border-stone-200">
            ...
            <form onSubmit={handleUpdateSubmit} className="space-y-6">
              ...
              {/* NEW: What You'll Learn (Objectives) */}
              ...
              {/* Assignments now live on the class dashboard, not this modal */}
